...
Actor.prototype.scrollsToOnTouch = function(targetX, targetY, duration){
  this.reacts("this.scrollsTo(" + targetX + "," + targetY + "," + duration + ", false, true, reactionTargetIndex);", 1);
  return this;
};
...
Actor.prototype.scrollsToOnTouch3 = function(targetX, targetY, layer, duration){
  this.reacts("this.scrollsTo(" + this.scene.getScrollAmountX(targetX,layer) + "," + this.scene.getScrollAmountY(targetY,layer) + "," + duration + ", true, reactionTargetIndex);", 1);
  return this;
};
