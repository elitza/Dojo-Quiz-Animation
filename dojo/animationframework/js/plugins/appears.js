...
Actor.prototype.appearsOnTouch = function(appearLength, startAfter){
  ...
  this.reacts("this.appears(" + integerValueOfOr(startAfter, 0) + "," + appearLength + ", true, false, reactionTargetIndex);", 1);
  return this;
};

Actor.prototype.appearsForeverOnTouch = function(appearLength, startAfter){
  this.setInitialOpacity(0);
  this.reacts("this.appearsForever(" + integerValueOfOr(startAfter, 0) + "," + appearLength + ", true, false, reactionTargetIndex);", 1);
  return this;
};

Actor.prototype.letsAppearStartsVisible = function(targetObject, appearLength, startAfter){
  this.reacts("this.appears(" + integerValueOfOr(startAfter, 0) + ", " + floatValueOfOr(appearLength, 1000) + ", true, true, reactionTargetIndex);", 1, targetObject);
  return this;
};

Actor.prototype.letsAppearForeverStartsVisible = function(targetObject, appearLength, startAfter){
  this.reacts("this.appearsForever(" + integerValueOfOr(startAfter, 0) + ", " + floatValueOfOr(appearLength, 1000) + ", true, true, reactionTargetIndex);", 1, targetObject);
  return this;
};
...
Actor.prototype.letsAppear = function(targetObject, appearLength, startAfter){
  ...
  this.reacts("this.appears(" + integerValueOfOr(startAfter, 0) + ", " + floatValueOfOr(appearLength, 1000) + ", false, true, reactionTargetIndex);", 1, targetObject);
  return this;
};
