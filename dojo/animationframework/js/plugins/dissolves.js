...
Actor.prototype.dissolvesOnTouch = function(dissolveLength, startAfter){
  this.reacts("this.dissolves(" + integerValueOfOr(startAfter, 0) + ", " + floatValueOfOr(dissolveLength, 1000) + ", true, reactionTargetIndex);", 1);
  return this;
};

Actor.prototype.dissolvesForeverOnTouch = function(dissolveLength, startAfter){
  this.reacts("this.dissolvesForever(" + integerValueOfOr(startAfter, 0) + ", " + floatValueOfOr(dissolveLength, 1000) + ", true, reactionTargetIndex);", 1);
  return this;
};

Actor.prototype.letsDissolveForever = function(targetObject, dissolveLength, startAfter){
  this.reacts("this.dissolvesForever(" + integerValueOfOr(startAfter, 0) + ", " + floatValueOfOr(dissolveLength, 1000) + ", true, reactionTargetIndex);", 1, targetObject);
  return this;
};

Actor.prototype.letsDissolve = function(targetObject, dissolveLength, startAfter){
  this.reacts("this.dissolves(" + integerValueOfOr(startAfter, 0) + ", " + floatValueOfOr(dissolveLength, 1000) + ", true, reactionTargetIndex);", 1, targetObject);
  return this;
};
